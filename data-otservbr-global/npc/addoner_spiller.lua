...
addoninfo = {
	...
	["first knightmare addon"] = { cost = 0, items = { { 6499, 1000 } }, outfit_female = 268, outfit_male = 269, addon = 1, storageID = 51016 },
	["second knightmare addon"] = { cost = 0, items = { { 6499, 1500 } }, outfit_female = 268, outfit_male = 269, addon = 2, storageID = 51017 },
	["first brotherhood addon"] = { cost = 0, items = { { 6499, 1000 } }, outfit_female = 278, outfit_male = 279, addon = 1, storageID = 51018 },
	["second brotherhood addon"] = { cost = 0, items = { { 6499, 1500 } }, outfit_female = 278, outfit_male = 279, addon = 2, storageID = 51019 },
	["first royal costume addon"] = { cost = 0, items = { { 22516, 10000 }, { 22721, 8000 } }, outfit_female = 1456, outfit_male = 1457, addon = 1, storageID = 47802 },
	["second royal costume addon"] = { cost = 0, items = { { 22516, 5000 }, { 22721, 4000 } }, outfit_female = 1456, outfit_male = 1457, addon = 2, storageID = 47803 },
}

local o = { "citizen", "hunter", "knight", "mage", "nobleman", "summoner", "warrior", "barbarian", "druid", "wizard", "oriental", "pirate", "assassin", "beggar", "shaman", "norseman", "knightmare", "brotherhood", "royal costume" }
local rtnt = {}
