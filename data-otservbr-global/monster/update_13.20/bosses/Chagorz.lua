...
monster.loot = {
	{ name = "crystal coin", chance = 19730, maxCount = 108 },
	{ name = "mastermind potion", chance = 12134, maxCount = 28 },
	{ name = "supreme health potion", chance = 13224, maxCount = 154 },
	{ name = "giant sapphire", chance = 9246, maxCount = 1 },
	{ name = "ultimate mana potion", chance = 5331, maxCount = 107 },
	{ name = "violet gem", chance = 8105, maxCount = 4 },
	{ id = 3039, chance = 6195, maxCount = 1 }, -- red gem
	{ name = "yellow gem", chance = 12513, maxCount = 1 },
	{ name = "blue gem", chance = 14968, maxCount = 3 },
	{ name = "bullseye potion", chance = 10028, maxCount = 21 },
	{ name = "giant amethyst", chance = 7132, maxCount = 1 },
	{ name = "giant topaz", chance = 6158, maxCount = 1 },
	{ name = "green gem", chance = 10043, maxCount = 1 },
	{ name = "ultimate spirit potion", chance = 8489, maxCount = 18 },
	{ name = "white gem", chance = 12218, maxCount = 3 },
