...
monster.attacks = {
	...
	{ name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -750, maxDamage = -2000, radius = 4, effect = CONST_ME_MORTAREA, target = false },
	...
	{ name ="combat", interval = 2000, chance = 10, type = COMBAT_FIREDAMAGE, minDamage = -800, maxDamage = -2250, length = 8, effect = CONST_ME_EXPLOSIONHIT, target = false }
}
