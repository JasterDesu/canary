local mType = Game.createMonsterType("VIP Dawnfire Asura")
local monster = {}

monster.description = "a VIP dawnfire asura"
...
monster.loot = {
	...
	{ id = 5911, chance = 1000660 }, -- red piece of cloth
