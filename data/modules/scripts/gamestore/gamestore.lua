...
HomeBanners = {
	images = { "home/banner_exercisedummies.png", "home/banner_retrooutfits.png", "home/banner_riftwatcher.png" },
	delay = 10,
}
...
GameStore.Categories = {
	...
	-- Vip ~ Variados
	{
		...
		offers = {
			...
			{
				icons = { "remove_skull.png" },
				name = "Remove Skull",
				price = 75,
				itemtype = 37338,
				count = 1,
				description = "Remove qualquer skull - 1x",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
	...
	-- Vip ~ Foods
	{
		...
		offers = {
			
			{
				...
				itemtype = 28484,
				count = 1,
				description = "recupera toda sua mana",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "blueberry_cupcake.png" },
			...
			},
			{
				...
				itemtype = 28485,
				count = 1,
				description = "recupera toda sua vida",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Strawberry_Cupcake.png" },
			...
			},
			{
				...
				itemtype = 28486,
				count = 5,
				description = "Aumenta seu distance skill em 10 pontos por 1hora",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
			...
			},
			{
				...
				itemtype = 9082,
				count = 5,
				description = "Aumenta seu magic level em 5 pontos por 1hora",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
	...
	-- Vip ~ Pocoes
	{
		...
		offers = {
			
			{
				...
				itemtype = 36727,
				count = 1,
				description = "1h pra double daquele loot SERELEPE!",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				...
				itemtype = 36736,
				count = 5,
				description = "Aumenta seu dano de Fogo em 8% por 1 hora",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "fire_amplification.png" },
			...
			},
			{
				...
				itemtype = 36729,
				count = 5,
				description = "Aumenta sua resistencia ao dano de Fogo em 8% por 1 hora",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "fire_amplification.png" },
			...
			},
			{
				...
				itemtype = 36737,
				count = 5,
				description = "Aumenta seu dano de Gelo em 8% por 1 hora",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "ice_amplification.png" },
			...
			},
			{
				...
				itemtype = 36730,
				count = 5,
				description = "Aumenta sua resistencia ao dano de gelo em 8% por 1 hora",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "ice_amplification.png" },
			...
			},
			{
				...
				itemtype = 36741,
				count = 5,
				description = "Aumenta seu dano de Morte em 8% por 1 hora",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "ice_amplification.png" },
			...
			{
				icons = { "ice_amplification.png" },
				name = "Death Resilence",
				price = 125,
				itemtype = 36734,
				count = 5,
				description = "Aumenta sua resistencia ao dano de Morte em 8% por 1 hora",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "ice_amplification.png" },
			...
			},
			{
				...
				itemtype = 36738,
				count = 5,
				description = "Aumenta seu dano de Terra em 8% por 1 hora",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "ice_amplification.png" },
			...
			{
				icons = { "ice_amplification.png" },
				name = "Earth Resilence",
				price = 125,
				itemtype = 36731,
				count = 5,
				description = "Aumenta sua resistencia ao dano de Terra em 8% por 1 hora",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "ice_amplification.png" },
			...
			},
			{
				...
				itemtype = 36739,
				count = 5,
				description = "Aumenta seu dano de Energy em 8% por 1 hora",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "ice_amplification.png" },
			...
			{
				icons = { "ice_amplification.png" },
				name = "Energy Resilence",
				price = 125,
				itemtype = 36732,
				count = 5,
				description = "Aumenta sua resistencia ao dano de Energy em 8% por 1 hora",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "ice_amplification.png" },
			...
			},
			{
				...
				itemtype = 36740,
				count = 5,
				description = "Aumenta seu dano de Holy em 8% por 1 hora",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "ice_amplification.png" },
			...
			},
			{
				...
				itemtype = 36733,
				count = 5,
				description = "Aumenta sua resistencia ao dano de Holy em 8% por 1 hora",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "ice_amplification.png" },
			...
			{
				icons = { "ice_amplification.png" },
				name = "Phisical Amplification",
				price = 125,
				itemtype = 36742,
				count = 5,
				description = "Aumenta seu dano de Phisical em 8% por 1 hora",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "ice_amplification.png" },
			...
			{
				icons = { "ice_amplification.png" },
				name = "Phisical Resilence",
				price = 125,
				itemtype = 36735,
				count = 5,
				description = "Aumenta sua resistencia ao dano de Phisical em 8% por 1 hora",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "ice_amplification.png" },
			...
			},
			{
				...
				itemtype = 36723,
				count = 5,
				description = "reinicia seus cooldown",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "ice_amplification.png" },
				...
				itemtype = 36723,
				count = 50,
				description = "reinicia seus cooldowns",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "ice_amplification.png" },
				...
				itemtype = 35563,
				count = 10,
				description = "Ativa ou recupera seu mana shield",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "ice_amplification.png" },
			...
			{
				icons = { "ice_amplification.png" },
				name = "strike enhancements",
				price = 250,
				itemtype = 36724,
				count = 5,
				description = "Aumenta sua chance de hit critico em 15% por 1 hora",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "ice_amplification.png" },
	...
	-- Consumables ~ Exercise Weapons
	{
		...
		offers = {
			...
			},
			{
				...
				name = "Durable Exercise Stick",
				price = 90,
				itemtype = 35284,
				charges = 1800,
				description = "<i>Use it to train your fist fighting on an exercise dummy!</i>\n\n{character}\n{storeinbox}\n{info} use it on an exercise dummy to train your magic level\n{info} usable 1800 times a piece",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},
			{
	...
	-- House ~ Decorations
	{
		...
		offers = {
			...
			{
				icons = { "witchcraft_forest_herbs.png" },
			...
			{
				icons = { "witchcraft_summoning_circle.png" },
			...
			{
				icons = { "witchcraft_sweet_herbs.png" },
	...
	-- House ~ Furniture
	{
		...
		offers = {
			...
			{
				icons = { "Chest_Full_of_Witchcraft.png" },
				name = "Chest Full of Witchcraft",
				price = 50,
				itemtype = 43679,
				count = 1,
				description = "{house}\n{box}\n{storeinbox}\n{useicon} use it to open up some storage space\n{backtoinbox}",
			...
			{
				icons = { "Table_with_Burning_Candles.png" },
			...
			{
				icons = { "witchcraft_bookstand.png" },
			...
			{
				icons = { "witchcraft_fireplace.png" },
